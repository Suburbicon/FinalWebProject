...
mix.styles([
    ...
    'resources/front/css/bootstrap4.3.1.css',
    'resources/front/css/registration.css',
    'resources/front/css/style.css',
],'public/css/front.css');

mix.scripts([
    'resources/front/js/bootstrap.bundle.min.js',
    'resources/front/js/bootstrap4.3.1.js',
    'resources/front/js/jqBootstrapValidation.js',
    'resources/front/js/jquery.mask.min.js',
    'resources/front/js/jquery.min.js',
    'resources/front/js/jquery.validate.js',
